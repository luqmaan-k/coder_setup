...
# Description:
#   For a given user this script:
#     - Lists all workspaces belonging to user using coder ls with a search filter.
...
#
# Usage: ./delete_single_user_workspaces.sh <username> 
# Example: ./delete_single_user_workspaces.sh admins
#
